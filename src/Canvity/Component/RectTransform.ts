namespace Canvity.Component {
    export class RectTransform extends Transform {
        ...
        public set Size(val: Util.Vector2) {
            this.size = val;
            
            if (this.CanvasObject !== null && this.CanvasObject !== undefined) {
                Messaging.MessageBus.PushMessage(new Messaging.Message(App.CurrentUpdateTime, 'transform.resize', this.CanvasObject.InstanceID), 1);
            }
        }
